...
// ─── Date range: Apr 1 → Dec 31, 2026 ────────────────────────────────────────
const JOURNEY_START = new Date('2026-04-01T00:00:00');
const JOURNEY_END   = new Date('2026-12-31T00:00:00');
const JOURNEY_DAYS  = Math.floor((JOURNEY_END - JOURNEY_START) / 86400000) + 1; // 275
...
export default function Heatmap({ history }) {
  ...
  return (
    <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 shadow-xl">
      ...
      <p className="text-slate-500 text-xs mb-5">Apr 1 → Dec 31, 2026 · Hover any day for details</p>
